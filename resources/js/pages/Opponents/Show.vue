                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            <h1 class="text-4xl font-semibold sm:text-5xl">
                                {{ archive.opponent.name }}
                            </h1>
                            <span v-if="archive.opponent.country" class="rounded-full bg-[#fffffe] px-3 py-1.5 text-sm font-semibold text-[#094067] shadow-sm">
                                {{ archive.opponent.country }}
                            </span>
                        </div>
                        <p class="mt-4 max-w-2xl text-sm leading-7 text-[#5f6c7b] sm:text-base">
                            {{ archive.opponent.description || `浏览${archive.opponent.name}相关的公开图片、相册和时间线入口。` }}
                        </p>
                    </div>
        ...
        <section class="px-4 py-8 sm:px-6 lg:px-8">
            <div class="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[280px_minmax(0,1fr)]">
                <aside class="space-y-5 lg:sticky lg:top-24 lg:self-start">
                    <section class="rounded-sm border border-[#90b4ce]/30 bg-[#fffffe] p-4 shadow-sm">
                        ...
                        <p class="mt-2 text-sm leading-6 text-[#5f6c7b]">
                            {{ archive.opponent.name }} 当前聚合 {{ archive.summary.photos_count }} 张公开图片。
                        </p>
                ...
                <div>
                    ...
                    <nav v-if="archive.photos.meta.last_page > 1" class="mt-10 flex items-center justify-between gap-4 border-t border-[#90b4ce]/30 pt-6" aria-label="对手聚合分页">
