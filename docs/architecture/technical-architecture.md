...
### ADR-0002 阶段 2A 实现状态（2026-09-12）
...
### ADR-0002 阶段 2B 实现状态（2026-09-12）

阶段 2B 已完成：管理员在用户管理中维护贡献方向、公开展示和排序；/supporters 将运营守护者与档案共建者分区展示；公开 payload 只包含经过确认的公开资料。没有新增公开申请、审核或取消申请流程，也没有扩大 editor 的权限边界。
